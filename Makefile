...
LDFLAGS=-ldflags "-s -w \
    -X github.com/bketelsen/bjk/cmd.CommitHash=${COMMIT_HASH} \
    -X github.com/bketelsen/bjk/cmd.BuildTime=${BUILD_TIME} \
    -X github.com/bketelsen/bjk/cmd.Tag=${VERSION_TAG}"
